...
#8. Print a string to upper case - UPPER TAKES ONE ARGUMENT
...
#10. Printing values inside strings (note there are several ways to fix this one) - 42 takes no double quotes as an integer
digit = 42
digit2 = "42"
print "The number %(d)i is the answer to life, the universe, and everything." % {'d':digit}
print "the number %(d)s is the answer to life, the universe, and everything." % {'d':digit2}
